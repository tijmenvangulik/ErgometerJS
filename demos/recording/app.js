...
class Demo {
    ...
    testWorkout() {
        return __awaiter(this, void 0, void 0, function* () {
            //set a distance
            yield this.performanceMonitor.newCsafeBuffer()
                .setDistance({ value: 3000, unit: 36 /* ergometer.Unit.distanceMeter */ })
                .setProgram({ value: 0 /* ergometer.Program.Programmed */ })
                .setScreenState({ screenType: 1 /* ergometer.ScreenType.Workout */, value: 1 /* ergometer.ScreenValue.PrepareToRowWorkout */ })
                .send();
            //set a fixed time
