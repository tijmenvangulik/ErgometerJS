    ...
    Byte 15: Work Per Stroke (LSB)
                        */
                        if (params.onDataReceived && data.byteLength >= 3) {
                            var strokeDistance = data.getUint16(0);
                            var driveTime = data.getUint8(2);
                            var strokeRecoveryTime = data.getUint16(3);
                            var strokeCount = data.getUint16(6);
...
var Demo = /** @class */ (function () {
    ...
    Demo.prototype.locationServiceWarning = function (sucess) {
        ...
        ble.isLocationEnabled(function () {
            ...
            _this.showInfo("Location services is not enabled. On some phones you can not find the ergometer device without this option switched on.  If you can not find your device enable location in the privacy settings of your android device.");
            sucess();
        });
    };
